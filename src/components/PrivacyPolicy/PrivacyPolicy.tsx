...
const PrivacyPolicy: React.FC<PolicyProps> = ({ name }: PolicyProps) => (
  <Container>
    <Row className="justify-content-md-center">
      ...
      <Col lg={8}>
        ...
        {/* eslint-disable-next-line */}
        <h1>{`// Privacy Policy of ${name}`}</h1>
        <p>
          {`Ted Bennett built the ${name} app as a Free app. This SERVICE is provided by Ted
        ...
        <p>
          ...
          {' '}
          <a href="mailto:ted_bennett@icloud.com">ted_bennett@icloud.com</a>
          .
        </p>
        <p>
